        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close bt" data-bs-dismiss="modal" data-dismiss="modal"  aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="partials/_markTaskHandle.php" enctype="multipart/form-data">
                        <div class="mb-3 my-3">
                        <input type="hidden" name="Com_operation_from_Puser_details" id="Com_operation_from_Puser_details">
                            <input type="hidden" name="Complete_Task_id" id="Complete_Task_id">
                            ...
                            <textarea class="form-control" name="PartnerDesc"
                                ...
                                id="edit_desc" style="height: 100px" required></textarea>
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    <button type="button bt" class="btn btn-secondary" data-bs-dismiss="modal" data-dismiss="modal">Close</button>
                    <button type="submit bt" class="btn btn-primary" name="completebtn" value='completing'>Mark As
                        Completed</button>
                </div>
                </form>
            </div>
                    ...
                    <form method="POST" action="partials/_markTaskHandle.php">
                        ...
                        <input type="hidden" name="Rej_operation_from_Puser_details" id="Rej_operation_from_Puser_details">
                            ...
                            <textarea class="form-control" name="PartnerDesc"
                                ...
                                id="edit_rejection_desc" style="height: 100px" required></textarea>
                        </div>
                </div>
                <div class="modal-footer">
